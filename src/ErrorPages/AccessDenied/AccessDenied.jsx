  ...
  return (
    <>
      <div className='h-screen flex flex-col justify-center items-center bg-gradient-to-r from-orange-300 via-orange-400 to-orange-600'>
        ...
        <div className='flex md:w-[90%] mx-auto justify-end items-center px-16 mt-8'>
          <div className='text-black rounded-xl bg-amber-100 px-4 py-3 text-md md:text-xl font-semibold cursor-pointer flex items-center  gap-3' onClick={() => navigate("/") }><IoArrowBackOutline size={26} />Go Back To<span className='text-orange-700 '>Home Page</span> </div>
        </div>
      </div>
    </>
  )
